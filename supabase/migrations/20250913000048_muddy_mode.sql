...
INSERT IGNORE INTO users (id, name, email, password, role, idNumber, contactNumber) VALUES
(1, 'Admin User', 'admin@hospital.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin', '1234567890123', '1234567890');

-- Insert sample doctor users (password: 'password')
INSERT IGNORE INTO users (id, name, email, password, role, doctorId, idNumber, contactNumber) VALUES
(2, 'Dr. Sarah Johnson', 'doctor@hospital.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'doctor', 'DOC001', '2345678901234', '2345678901'),
(3, 'Dr. James Wilson', 'doctor2@hospital.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'doctor', 'DOC002', '3456789012345', '3456789012');

-- Insert sample patient user (password: 'password')
INSERT IGNORE INTO users (id, name, email, password, role, idNumber, contactNumber) VALUES
(4, 'Jane Smith', 'patient@example.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'patient', '4567890123456', '4567890123');